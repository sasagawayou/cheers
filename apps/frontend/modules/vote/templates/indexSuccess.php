...
<html>
  ...
  <body>
    ...
    <div align="center">
      ...
      <div id="description"><?php echo nl2br($description); ?></div><br></br>
    </div>

    <?php foreach ($vote_comments as $vote_comment) {
      if ($sf_user->getName() == $vote_comment->getUser()) { ?>
        <div id="comment" align="left">&nbsp;&nbsp;&nbsp;<?php echo $vote_comment->getUser(); ?>::<br>
          &nbsp;&nbsp;&nbsp;<?php echo nl2br($vote_comment->getComment()); ?>
      ...
      <?php } else { ?>
        <div id="comment">&nbsp;&nbsp;&nbsp;<?php echo $vote_comment->getUser(); ?>::<br>
          &nbsp;&nbsp;&nbsp;<?php echo nl2br($vote_comment->getComment()); ?></div>
      <?php }
    }; ?>
