...
/**
 * Vote_comment form base class.
 *
 * @method Vote_comment getObject() Returns the current form's model object
 *
 * @package    connect
 * @subpackage form
 ...
 */
abstract class BaseVote_commentForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'user'       => new sfValidatorString(array('max_length' => 65, 'required' => false)),
